...
//        }
    ...
    public void loop() {
        ...
        // automation
        if (!(robot.actuators.runningAlliance || robot.actuators.runningDeposit || robot.actuators.runningShared)) {
        ...
        } else if (robot.actuators.runningAlliance && !robot.actuators.runningDeposit) {
