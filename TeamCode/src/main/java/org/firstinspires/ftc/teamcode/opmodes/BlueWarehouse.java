...
//    public static Pose2d INTAKE1 = new Pose2d(40, 63.5, Math.toRadians(0));
//    public static Pose2d SCORE1 = new Pose2d(12, 63.5, Math.toRadians(0));
//    public static Pose2d INTAKE2 = new Pose2d(44, 63.5, Math.toRadians(0));
//    public static Pose2d SCORE2 = new Pose2d(12, 63.5, Math.toRadians(0));
//    public static Pose2d INTAKE3 = new Pose2d(48, 63.5, Math.toRadians(0));
//    public static Pose2d SCORE3 = new Pose2d(12, 63.5, Math.toRadians(0));
//    public static Pose2d PARK = new Pose2d(50, 63.5, Math.toRadians(0));
//
//    @Override
...
//
//        // cycle
//        cycleBlockInAuto(1000, intake1, score1, creep, alliance, RIGHT);
