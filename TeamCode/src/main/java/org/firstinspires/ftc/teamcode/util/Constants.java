...
//    public static final Detection INVALID_DETECTION = new Detection(new Size(0, 0), 0);
    ...
    public static final String WHEEL_BL = "BL";
    public static final String WHEEL_BR = "BR";
    public static final String WHEEL_FR = "FR";
    public static final String WHEEL_FL = "FL";
