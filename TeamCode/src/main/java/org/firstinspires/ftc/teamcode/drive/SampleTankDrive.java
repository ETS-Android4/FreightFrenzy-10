...
public class SampleTankDrive extends TankDrive {
    ...
    public static PIDCoefficients CROSS_TRACK_PID = new PIDCoefficients(2, 0, 0);
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "driveFrontLeft");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "driveBackLeft");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "driveBackRight");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "driveFrontRight");
